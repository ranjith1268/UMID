...
def show_patient_dashboard():
    ...
    with col1:
        if st.button("📅 Book Appointment", use_container_width=True):
            st.info("📞 Please call +1-555-MEDICAL to book an appointment")
...
def show_admin_dashboard():
    ...
    tab1, tab2, tab3, tab4, tab5 = st.tabs(["System Overview", "User Management", "Activity Logs", "Biometric Setup", "System Settings"])
...
def show_pharmacy_dashboard():
    ...
    try:
        ...
        tab1, tab2, tab3, tab4 = st.tabs(["Inventory Overview", "Stock Management", "Add Medication", "Reports"])
